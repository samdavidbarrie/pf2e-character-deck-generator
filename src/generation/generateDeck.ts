...
import { generateSpellCards, generateFocusSpellCards } from "./templates/spells";
...
export function generateDeck(char: CharacterModel): GenerationResult {
  ...
  if (char.feats.length > 0) {
    ...
    warnings.push({ type: "warning", message: "No feats were found; feat cards were not generated." });
  }
