...
import { blankField, checkboxField, defaultCard, notesField } from './_helpers';
...
const REMINDERS: ReminderDef[] = [
  ...
  },
  {
    ...
    summary:
      'Spend 1: reroll a d20 and take the better result. Spend all 3: avoid dying when you would be reduced to 0 HP.',
  ...
  },
  {
    ...
    summary:
      'At 0 HP: gain Dying 1 (or higher if Wounded). Each turn: Recovery Check (DC 10 + Dying value). Dying 4 = dead. On recovery: remove Dying, gain Wounded +1.',
  ...
  },
  {
    ...
    summary:
      'At end of your turn: take damage, then attempt a DC 15 flat check. On success: remove condition. Others can Aid (reduce DC to 10).',
  ...
  },
  {
    ...
    summary:
      'Lesser cover: +1 AC. Standard cover: +2 AC and Reflex, can Hide. Greater cover: +4 AC and Reflex, can Hide. Concealed: –2 attack vs. you. Hidden: –4 attack vs. you and must Seek.',
  },
  {
    title: 'Common Conditions',
    stableKeySuffix: 'common-conditions',
    summary:
      "Frightened: –X to checks and DCs (reduces by 1/round). Flat-footed: –2 AC. Prone: –2 attack, +2 AC vs. ranged. Grabbed: flat-footed + can't move.",
  ...
  },
  {
    ...
    summary:
      '8 hours of sleep: refocus, regain HP (level × con mod, min 1). Daily prep: prepare spells, re-invest items, activate daily consumables.',
  },
];
